    ...
    <main className="pt-24">
      ...
      <section className="py-16 bg-[#0A0A0F]">
        <div className="max-w-5xl mx-auto px-6">
          <ScrollReveal className="text-center mb-12">
            <h2 className="text-3xl font-black text-white" style={{ fontFamily: 'Cabinet Grotesk, sans-serif' }}>
          ...
          <div className="flex flex-col gap-3">
            {openRoles.map((role, i) => (
              <motion.div key={role.title} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.06 }}
                ...
                <div>
                  <div className="text-white font-semibold mb-1">{role.title}</div>
      ...
      <section id="apply" className="py-24 bg-[#050508]">
        <div className="max-w-3xl mx-auto px-6">
          <ScrollReveal className="text-center mb-12">
            <h2 className="text-3xl font-black text-white mb-3" style={{ fontFamily: 'Cabinet Grotesk, sans-serif' }}>
              Apply Now
            </h2>
